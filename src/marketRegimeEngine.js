...
export const REGIME_CONFIG = {
  risk_on: {
    label:       'Entorno Risk-On',
    description: 'Flujos de capital favoreciendo activos de riesgo. Presión alcista generalizada en pares correlacionados.',
    color:  '#22c55e',
    bg:     'rgba(34,197,94,0.07)',
    border: 'rgba(34,197,94,0.18)',
  },
  risk_off: {
    label:       'Condiciones Risk-Off',
    description: 'Aversión al riesgo activa. Flujos hacia refugios seguros dominando. Demanda de USD y JPY elevada.',
    color:  '#ef4444',
    bg:     'rgba(239,68,68,0.07)',
    border: 'rgba(239,68,68,0.18)',
  },
  trending: {
    label:       'Entorno Tendencial',
    description: 'Momentum direccional presente en pares correlacionados. Contexto de continuación estructural activo.',
    color:  '#3b82f6',
    bg:     'rgba(59,130,246,0.07)',
    border: 'rgba(59,130,246,0.18)',
  },
  mean_reverting: {
    label:       'Condiciones de Reversión a Media',
    description: 'Movimientos extendidos comprimiéndose. Comportamiento en rango en aumento. Tendencias estructurales moderándose.',
    color:  '#8b5cf6',
  ...
  high_volatility: {
    ...
    description: 'Expansión de volatilidad activa en pares. Acción del precio acelerando. Incertidumbre de contexto amplia.',
    color:  '#f97316',
    bg:     'rgba(249,115,22,0.07)',
    border: 'rgba(249,115,22,0.18)',
  },
  macro_uncertainty: {
    label:       'Incertidumbre Macro',
    description: 'Señales direccionales mixtas en pares. Posicionamiento institucional divergiendo. Aguardar claridad.',
    color:  '#f59e0b',
    bg:     'rgba(245,158,11,0.07)',
    border: 'rgba(245,158,11,0.18)',
  },
  compression: {
    label:       'Compresión de Mercado',
    description: 'Baja convicción en activos correlacionados. Esperar catalizador institucional para claridad direccional.',
    color:  '#6b7280',
    bg:     'rgba(107,114,128,0.07)',
    border: 'rgba(107,114,128,0.18)',
  },
  macro_expansion: {
    label:       'Expansión Macro',
    description: 'Flujo institucional generalizado activo. Contexto direccional estructural elevado en majors.',
    color:  '#06b6d4',
